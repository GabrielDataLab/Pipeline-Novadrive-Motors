-- ============================================
-- NovaDrive Motors — Snowflake Setup
-- Executa na ordem: database > schema > warehouse > tabelas
-- ============================================
...
-- 2. Criar warehouse de processamento
CREATE WAREHOUSE DEFAULT_WH;

-- 3. Criar tabelas no schema STAGE
-- (serão populadas pela DAG do Airflow)
